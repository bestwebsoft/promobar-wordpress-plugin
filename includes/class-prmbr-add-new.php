...
if ( ! class_exists( 'Prmbr_Single_Tabs' ) ) {
	class Prmbr_Single_Tabs extends Bws_Settings_Tabs {
		...
		public function __construct( $plugin_basename ) {
			...
			/* Get slider ID. */
			$this->prmbr_id = ! empty( $_REQUEST['prmbr_id'] ) ? intval( $_REQUEST['prmbr_id'] ) : "";
		...
		public function display_content() {
			...
			<h1>
				...
				if ( ! empty( $this->prmbr_id ) ) {
					echo __( 'Edit Promobar', 'promobar' ) . '<span id="prmbr_btn_add_new" class="page-title-action" >' . __( 'Add New', 'promobar' ) . '</span>';
				} else {
					_e( 'Add New Promobar', 'promobar' );
				} ?>
			</h1>
			<?php $this->display_messages( $save_results ); ?>
            <form class="bws_form" method="POST" action="admin.php?page=promobar-new.php<?php echo ! empty( $this->prmbr_id ) ? '&prmbr_id=' . $this->prmbr_id : ''; ?>">
                <div id="poststuff">
                    <div id="post-body" class="metabox-holder columns-2">
                        <div id="post-body-content" style="position: relative;">
                            <?php $this->pro_block( 'prmbr_title', array( 'background' => $this->options['background'], 'url' => $this->options['url'] ) ); 
                            $this->display_tabs(); ?>
                        </div><!-- #post-body-content -->
                        <div id="postbox-container-1" class="postbox-container">
                            <div class="meta-box-sortables ui-sortable">
                                <div id="submitdiv" class="postbox">
                                    <h3 class="hndle"><?php _e( 'Publish', 'promobar' ); ?></h3>
                                    <div class="inside">
                                        <div class="submitbox" id="submitpost">
                                            <div id="major-publishing-actions">
                                                <div id="publishing-action">
                                                    <input type="hidden" name="<?php echo $this->prefix; ?>_form_submit" value="submit" />
                                                    <input id="bws-submit-button" type="submit" class="button button-primary button-large" value="<?php _e( 'Update', 'promobar' ); ?>" />
								...
								<div class="postbox">
									...
									<div class="inside">
										<?php _e( "Add PromoBar to your posts, pages, custom post types or widgets by using the following shortcode:", 'promobar' ); ?>
        ...
        public function tab_settings() { ?>
            ...
            <table class="form-table">
                <tr>
                    <th><?php _e( 'Display Promobar', 'promobar' ); ?></th>
                    <td>
                        <label>
            ...
            <?php $this->pro_block( 'prmbr_date', array( 'background' => $this->options['background'], 'url' => $this->options['url'] ) ); ?>
            <table class="form-table">
                <tr class="prmbr_enable">
                ...
                <tr class="prmbr_enable">
                    ...
                    <td>
                        <fieldset>
                            ...
                            <?php $this->pro_block( 'prmbr_popup', array( 'background' => $this->options['background'], 'url' => $this->options['url'] ) ); ?>        
                        </fieldset>
                    </td>
                </tr>
                <tr class="prmbr_enable">
